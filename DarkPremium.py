...
def menu():
    ...
    print((k+"["+p+"7"+k+"]"+p+" Chek Opsi Akun CP"))
    print((k+"["+p+"8"+k+"]"+p+" Result Crack"))
    print((k+"["+p+"9"+k+"]"+p+" User Agent"))
...
def target():
    ...
    for yes in self:
        fl = yes.replace('\n', '')
        ya = fl.split('|')
        print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Proses :\033[0;33m ' + fl.replace(' + ', '')")
